...
```{r econDataClean, echo=TRUE, cache=TRUE, warning=FALSE}
df$PROPDMGEXP[df$PROPDMGEXP == "K"] <- "000"
df$PROPDMGEXP[df$PROPDMGEXP == "M"] <- "000000"
df$PROPDMGEXP[df$PROPDMGEXP == "B"] <- "000000000"
df$CROPDMGEXP[df$CROPDMGEXP == "K"] <- "000"
df$CROPDMGEXP[df$CROPDMGEXP == "M"] <- "000000"
df$CROPDMGEXP[df$CROPDMGEXP == "B"] <- "000000000"
head(df$PROPDMGEXP)
head(df$CROPDMGEXP)
```
<!---Links--->
